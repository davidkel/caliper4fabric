...
const { connect, signers } = require('@davidkel/fabric-gateway');
const { ConnectorBase, CaliperUtils, TxStatus, Version, ConfigUtil } = require('@davidkel/caliper-core');
...
class PeerGateway extends ConnectorBase {
    ...
    constructor(connectorConfiguration, workerIndex, bcType) {
        ...
        this.fabricGatewayVersion = new Version(require('@davidkel/fabric-gateway/package').version);
