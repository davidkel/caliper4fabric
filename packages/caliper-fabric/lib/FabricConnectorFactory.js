...
const { CaliperUtils, ConfigUtil } = require('@davidkel/caliper-core');
...
const _determineInstalledNodeSDKandVersion = () => {
    ...
    if (CaliperUtils.moduleIsInstalled('@davidkel/fabric-gateway')) {
        packageVersion = semver.coerce(require('@davidkel/fabric-gateway/package').version);
        sdk = 'fabric-gateway';
    }
